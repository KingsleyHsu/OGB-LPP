...
def create_gnn_layer(input_channels, hidden_channels, num_layers, dropout=0, encoder_name='SAGE'):
    ...
    elif encoder_name.upper() == 'GCNWITHATTENTION':
        return GCNWithAttention(input_channels, hidden_channels, hidden_channels, num_layers, dropout)
    else:
